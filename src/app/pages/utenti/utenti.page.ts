...
export class UtentiPage implements OnInit {
  ...
  columnNames = ['username', 'name', 'surname', 'email', 'phone', 'license', 'id_code', 'role', 'created_at', 'actions'];

  exampleDatabase: DataService<User> | null;
  ...
  constructor(
    ...
    public dataService: DataService<User>,
  ...
  loadData() {
    ...
    this.exampleDatabase.setPath('user');
...
export class ExampleDataSource extends DataSource<User> {
  ...
  constructor(
    public exampleDatabase: DataService<User>,
  ...
  connect(): Observable<User[]> {
    ...
    return merge(...displayDataChanges).pipe(map(() => {
      // Filter data
      this.filteredData = this.exampleDatabase.data.slice().filter((item: User) => {
